...
const handles: HandleLink[] = [
  {
    ...
    extraLinks: [
      {
        label: "Facebook",
        href: "https://www.facebook.com/JamiatPK",
      },
      {
        label: "𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦",
        href: "https://www.instagram.com/jamiatpk",
      },
      {
        label: "𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩",
        href: "https://wa.me/923349519657",
      },
      {
        label: "𝐓𝐢𝐤𝐓𝐨𝐤",
        href: "https://www.tiktok.com/@jamiatpk",
      },
      {
        label: "𝐘𝐨𝐮𝐓𝐮𝐛𝐞",
        href: "https://www.youtube.com/@JamiatPK",
      },
      {
        label: "𝐗 (𝐅𝐨𝐫𝐦𝐞𝐫 𝐓𝐰𝐢𝐭𝐭𝐞𝐫)",
        href: "https://x.com/JamiatPK",
      },
    ],
